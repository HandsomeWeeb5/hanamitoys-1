...
@section('title', 'Orders Dibatalkan')
...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Pengiriman Dibatalkan</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="{{ url('admin') }}">Home</a></li>
          <li class="breadcrumb-item"><a href="{{ route('shipments.index') }}">Pengiriman</a></li>
          <li class="breadcrumb-item"><a href="{{ route('orders.show', $order->id) }}">{{ $order->code }}</a></li>
    ...
    <div class="col-lg-6">
      <div class="card card-default">
        <div class="card-header card-header-border-bottom">
          <h2>Batalkan Order #{{ $order->code }}</h2>
        </div>
        <div class="card-body">
          ...
          <div class="form-footer pt-5 border-top">
            ...
            <a href="{{ url('admin/orders', $order->id) }}" class="btn btn-secondary">Kembali</a>
          </div>
          {!! Form::close() !!}
        </div>
      </div>
