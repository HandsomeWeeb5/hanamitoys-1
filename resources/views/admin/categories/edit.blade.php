        ...
        <div class="card-body">
          ...
          <form action="{{ route('categories.update', $category->id) }}" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="name" id="name" placeholder="Masukan Nama Kategori" value="{{ $category->name }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-footer pt-4 pt-5 mt-4 border-top text-center">
              <button name="submit" type="submit" class="btn btn-primary mr-2">Ubah</button>
