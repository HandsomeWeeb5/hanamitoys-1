...
<div class="container" style="background-color: white;">
  <div class="row py-5">
    <div class="col-md-6">
      ...
      <img class="img-fluid" src="{{ asset('storage/'.$image->medium) }}" alt="{{ $product->name }}">
      @empty
      No image found!
      @endforelse
    </div>
    <div class="col-md-6">
      ...
      <p class="mb-3">{!! nl2br($product->description) !!}</p>
      <div class="filter mb-3">
        ...
        <p class="mb-1">Tipe Figure : <a href="{{ url('products?tf=' . $attributes->id ) }}">{{ $attributes->name }}</a></p>
      </div>
      ...
      <div style="display: none;">
        {!! Form::select('figure', $figures , null, ['class' => 'select', 'required' => true]) !!}
      </div>
      @endif
